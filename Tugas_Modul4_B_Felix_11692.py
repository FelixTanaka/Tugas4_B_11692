...
def scatter(model, model_name, data, new_point, color_scale, title):
...
st.set_page_config(
    page_title="11692 - Unsupervised Learning", 
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Felix</h1>", unsafe_allow_html=True) 
    st.dataframe(input_data)


model_directory = r'C:\Users\LENOVO\Downloads\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)'
model_path = {
